...
<style scoped>
.text-authoring { display: flex; flex-direction: column; gap: 7px; padding: 9px; color: var(--text-secondary); border-bottom: 1px solid var(--border-subtle); font-size: 10px; }.text-authoring > strong { color: var(--text-primary); font-size: 10px; font-weight: 620; } label { display: flex; min-width: 0; align-items: center; justify-content: space-between; gap: 6px; } textarea, input { min-width: 0; max-width: 160px; padding: 5px 6px; color: inherit; background: var(--bg-input); border: 1px solid var(--border-strong); border-radius: 3px; font: inherit; } textarea { height: 48px; resize: vertical; } input:not([type=color]):not([type=file]) { height: 24px; } input[type=file] { width: 160px; padding: 3px; font-size: 8px; } input[type=color] { width: 28px; height: 24px; padding: 2px; } button { height: 24px; width: fit-content; padding: 0 7px; color: inherit; background: var(--bg-input); border: 1px solid var(--border-strong); border-radius: 3px; font: inherit; cursor: pointer; white-space: nowrap; } button:hover { color: var(--text-primary); background: var(--bg-hover); border-color: var(--accent-border); } button[aria-pressed=true] { color: var(--accent); background: var(--bg-selected); border-color: var(--accent-border); } details { padding: 6px; background: var(--bg-panel-alt); border: 1px solid var(--border-subtle); border-radius: 3px; } summary { color: var(--text-muted); cursor: pointer; } details label { margin-top: 6px; } small { color: var(--text-muted); line-height: 1.35; } small[role=alert] { color: var(--danger); }
</style>
