...
.playhead { z-index: 13; top: 2px; background: #e4b767; }.playhead span { top: 0; margin-left: -6px; width: 13px; height: 11px; background: #e4b767; clip-path: polygon(0 0, 100% 0, 100% 60%, 50% 100%, 0 60%); }.playhead i { top: 0; left: -2px; width: 5px; background: rgb(228 183 103 / .06); }
</style>
